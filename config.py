...
class Config(object):
    SECRET_KEY = os.environ.get('Z598Q~E-5ejwz2~xlJs8K_pfKFJYXZAVHlPKpaZy') or 'Z598Q~E-5ejwz2~xlJs8K_pfKFJYXZAVHlPKpaZy'
    ...
    SQL_SERVER = os.environ.get('udacity-cvxdedp-abm-cms.database.windows.net') or 'udacity-cvxdedp-abm-cms.database.windows.net'
